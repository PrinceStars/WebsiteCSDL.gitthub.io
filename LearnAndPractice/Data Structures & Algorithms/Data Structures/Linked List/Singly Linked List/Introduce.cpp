...
*/
    ...
    /* data has been assigned to the data part of the third block (block pointed by third). And next pointer 
	...
	Note that only the head is sufficient to represent the whole list. We can traverse the complete 
